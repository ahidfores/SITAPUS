              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title" style="text-transform: capitalize;">
                    <h2 >Data Transaksi Tabungan <small></small></h2>
                  ...
                  <div class="col-md-5 col-sm-15 col-xs-15" style="margin-left: 0px;">
                    <h4><small>Total Saldo Tabungan Keseluruhan: </small>Rp. <?php echo rupiah($saldo_keseluruhan);?></h4>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-bordered">
                      ...
                      <?php 
                          $no = 0;
                          $query=mysqli_query($conn,"SELECT * FROM transaksiTabungan JOIN nasabah ON transaksiTabungan.id_nasabah=nasabah.id_nasabah order by id_transaksi asc ");
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-6">
                    <?php
                      $query = "SELECT max(id_transaksi) as maxID FROM transaksiTabungan ";
