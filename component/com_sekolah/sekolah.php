              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title" style="text-transform: capitalize;">
                    <h2 > Data Sekolah <small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="hidden"  class="form-control"  name="id"  value="<?php echo $r['id_sekolah'];?>" />
...
<?php  } elseif ($_GET['aksi'] == 'simpan'){
    $module = $_GET['module'];
    mysqli_query($conn,"UPDATE sekolah SET nama_sekolah = '$_POST[nama_sekolah]',
                                    alamat = '$_POST[alamat]',
