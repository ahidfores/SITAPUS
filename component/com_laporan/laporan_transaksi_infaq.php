            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <form action="?module=laporan_transaksi_infaq&aksi=periode_masuk"  enctype="multipart/form-data" method="POST">
             ...
             <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <form action="?module=laporan_transaksi_infaq&aksi=periode_keluar"  enctype="multipart/form-data" method="POST">
                      
                  <select class="form-select" id="select_bulan2" aria-label="Default select example">
                      <option selected>Pilih Bulan</option>
                      <option value="1">Januari</option>
                      <option value="2">Februari</option>
                      <option value="3">Maret</option>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="col-md-9 col-sm-12 col-xs-12">
                   <form action="cetak_infaq.php" target="_blank" enctype="multipart/form-data" method="GET">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable"  class="table table-bordered">
                      ...
                      $tgl2 = date('Y-m-d', strtotime($tanggal2 ));
                          ...
                          $no = 0;
                          $query=mysqli_query($conn,"SELECT * FROM transaksi_infaq JOIN nasabah ON transaksi_infaq.id_nasabah=nasabah.id_nasabah WHERE (tanggal BETWEEN '$tgl1' AND '$tgl2') order by id_infaq asc ");
