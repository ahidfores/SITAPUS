            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   <form action="?module=laporan_transaksi_nasabah&aksi=nasabah"  enctype="multipart/form-data" method="POST">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable"  class="table table-bordered">
                      ...
                      $tgl2 = date('Y-m-d', strtotime($tanggal2 ));
                          ...
                          $no = 0;
                          $query=mysqli_query($conn,"SELECT * FROM transaksiTabungan JOIN nasabah ON transaksiTabungan.id_nasabah=nasabah.id_nasabah WHERE (tanggal BETWEEN '$tgl1' AND '$tgl2') order by id_transaksi asc ");
                  ...
                  <div class="x_content">
                    ...
                    <table class="table table-bordered">
                      ...
                      $tgl2 = date('Y-m-d', strtotime($tanggal2 ));
                          ...
                          $no = 0;
                          $query=mysqli_query($conn,"SELECT * FROM transaksiTabungan JOIN nasabah ON transaksiTabungan.id_nasabah=nasabah.id_nasabah WHERE (tanggal BETWEEN '$tgl1' AND '$tgl2') AND transaksiTabungan.id_nasabah= '$r[id_nasabah]' order by id_transaksi asc ");
