                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><a  class='open_modal btn  btn-default btn-xs' href="?module=<?php echo $_GET['module'];?>&aksi=edit&id=<?php echo encrypt($row[id_pegawai]);?>"><i class="glyphicon glyphicon-edit"></i> Edit</a> <a class="btn  btn-danger btn-xs"  onclick="confirm_modal('?module=<?php echo $_GET['module'];?>&aksi=hapus&id=<?php echo encrypt($row[id_pegawai]);?>');"><i class="glyphicon glyphicon-trash"></i> Hapus</a></td></td>
                        </tr>
                      <?php } ?>  
                      </tbody>
                    </table>
    ...
    <div class="modal-content">
      ...
      <form action="?module=<?php echo $_GET['module'];?>&aksi=simpan"  enctype="multipart/form-data" method="POST">
        <?php
          ...
          $query_2 = "SELECT max(no_pegawai) as maxPEG FROM pegawai ";
        ...
        ?>
                      ...
                      <input type="hidden"  class="form-control" autocomplete="off"  name="no_pegawai"  value="<?php echo $newID_2;?>" />
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="row">
                      ...
                      <input type="text"  class="form-control" disabled value="<?php echo $r['no_pegawai'];?>"  />
