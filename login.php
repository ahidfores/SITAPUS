      ...
      <div class="login_wrapper">
        ...
        <div class="animate form login_form">
          ...
          <section class="login_content">
            <img src="build/images/logo mi.png" width="60%">
          <h2 style="font-size: 25px; font-weight: 600;color: #26b99a;">SITAPUS</h2>
          <h2 style="font-size: 18px; font-weight: 200; color: #26b99a;">Sistem Informasi Tabung Pintar dan Pembayaran Uang Sekolah</h2>
