...
$nama_file = 'lap_transaksi_masuk-infaq';
$tanggal1 = $_GET[t1];
$tanggal2 = $_GET[t2];
...
<h3> <a  style="font-size: 30px;">	<img src="build/images/logo mi.png" width="10%">&nbsp;<?php echo  $r[nama_sekolah];?>  </h3> 
  ...
  <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Laporan Masuk Transaksi Infaq </h3>
...
FROM transaksi_infaq JOIN nasabah ON transaksi_infaq.id_nasabah=nasabah.id_nasabah WHERE (tanggal BETWEEN '$tgl1' AND '$tgl2') order by id_infaq asc "; // Tampilkan semua data gambar
