...
$nama_file = 'lap_transaksi-keluar_infaq';
$tanggal1 = $_GET[t1];
$tanggal2 = $_GET[t2];
...
transaksi_infaq.id_infaq, transaksi_infaq.total_infaq,transaksi_infaq.keterangan, pegawai.nama, transaksi_infaq.debit, transaksi_infaq.kredit
FROM transaksi_infaq JOIN pegawai ON transaksi_infaq.id_pegawai=pegawai.id_pegawai WHERE (tanggal BETWEEN '$tgl1' AND '$tgl2') order by id_infaq asc "; // Tampilkan semua data gambar
...
<!-- <td><?php echo $data['total_infaq'];?></td> -->
<?php if($count==1){?>
